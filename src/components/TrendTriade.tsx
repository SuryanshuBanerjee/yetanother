      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-shrink-0 mx-auto lg:mx-0">
          <svg width={300} height={280} viewBox="0 0 300 280" className="overflow-visible">
            ...
            {/* Data points */}
            {dataPoints.map((p, i) => (
              <circle key={i} cx={p.x} cy={p.y} r={4} fill={scoreColor(dims[i].data.score).bg === "bg-green-400" ? "#4ade80" : scoreColor(dims[i].data.score).bg === "bg-yellow-400" ? "#facc15" : "#f87171"} stroke="white" strokeWidth={1.5} />
            ))}
